  ...
  <div class="container py-4" v-if="isAdmin">
    ...
    <div class="admin-tabs mb-4">
      ...
      >
        ...
        <span v-if="totalUsers > 0" class="admin-tab-count">{{
          totalUsers
        }}</span>
      </button>
      <button
      ...
      >
        ...
        <span v-if="totalPosts > 0" class="admin-tab-count">{{
          totalPosts
        }}</span>
      </button>
    </div>
            ...
            <div class="card-body">
              ...
              >
                <h5 class="card-title mb-0">
                  <i class="bi bi-clock me-1"></i>Recent Signups
                </h5>
                <button
              ...
              <div v-if="loadingUsers">
                <div v-for="n in 3" :key="n" class="admin-list-item">
                  ...
                  <div class="flex-grow-1">
                    ...
                    <div
                      class="admin-skeleton-line"
                      style="width: 75%; margin-top: 6px; height: 10px"
                    ></div>
                  </div>
                  <div
                    class="admin-skeleton-line"
                    style="width: 50px; height: 22px; border-radius: 20px"
                  ></div>
                </div>
              </div>
                ...
                >
                  ...
                  >
                    <template v-if="u.role === 'admin'"
                      ><i class="bi bi-shield-fill me-1"></i>Admin</template
                    >
                    <template v-else
                      ><i class="bi bi-person me-1"></i>User</template
                    >
                  </span>
                </div>
              </div>
        ...
        <div class="col-md-6">
          <div class="card h-100">
            <div class="card-body">
              ...
              >
                <h5 class="card-title mb-0">
                  <i class="bi bi-clock me-1"></i>Recent Posts
                </h5>
                <button
              ...
              <div v-if="loadingPosts">
                <div v-for="n in 3" :key="n" class="admin-list-item">
                  ...
                  <div class="flex-grow-1">
                    ...
                    <div
                      class="admin-skeleton-line"
                      style="width: 50%; margin-top: 6px; height: 10px"
                    ></div>
                  </div>
                  <div
                    class="admin-skeleton-line"
                    style="width: 55px; height: 22px; border-radius: 20px"
                  ></div>
                </div>
              </div>
              ...
              >
                ...
                <p class="admin-empty-sub">
                  Community posts will appear here once submitted.
                </p>
              </div>
                ...
                >
                  ...
                  <div class="flex-grow-1 min-w-0">
                    ...
                    <div class="admin-post-meta">
                      by {{ p.userName }} · {{ formatDate(p.createdAt) }}
                    </div>
                  </div>
                  <div class="d-flex align-items-center gap-2">
                    <span v-if="p.category" class="admin-category-badge">{{
                      p.category
                    }}</span>
                    <button
      ...
      >
        <div class="admin-modal">
          ...
          <div class="d-flex gap-2 justify-content-center mt-3">
            ...
            <button class="btn btn-danger" @click="confirmDeletePost">
              Delete
            </button>
          </div>
        </div>
    ...
    <Teleport to="body">
      <div
        v-if="confirmRole"
        class="admin-modal-backdrop"
        @click.self="confirmRole = null"
      >
        <div class="admin-modal">
          <div class="admin-modal-icon">
            <template v-if="confirmRole.newRole === 'admin'"
              ><i class="bi bi-shield-fill"></i
            ></template>
          ...
          <div class="d-flex gap-2 justify-content-center mt-3">
            ...
            <button
              class="btn"
              :class="
                confirmRole.newRole === 'admin' ? 'btn-primary' : 'btn-danger'
              "
