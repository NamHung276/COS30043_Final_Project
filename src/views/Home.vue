...
export default {
  ...
  setup() {
    ...
    return { toast, metacriticClass, ratingStars, ratingLabel, formatDate, gamePrice, gameDiscount, discountedPrice };
  },
  ...
  <div>
    ...
    >
      ...
      <div class="container py-5" style="position: relative; z-index: 2">
        ...
        <div class="scs-main skeleton">
          <div style="display: flex; height: 100%; width: 100%; align-items: center; justify-content: center; opacity: 0.3; color: var(--text-muted)">
